...
#pragma config(Motor,  port4,           liftRightMid,  tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port7,           liftLeftTop,   tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           liftRightOut,  tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           liftLeftOut,   tmotorVex393_MC29, openLoop, reversed)
